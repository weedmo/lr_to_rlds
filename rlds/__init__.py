...
# Make transformations import optional - it requires 'reverb' which may not be installed
try:
    from rlds import transformations
except ImportError:
    transformations = None  # transformations module unavailable without reverb
